        ...
        <div className="project-grid">
          <div className="project-card">
            ...
            <div className="project-info">
              ...
              <Link to="/projects#prime-port-logistics" className="btn-more">
                Learn More
              </Link>
            </div>
          </div>
          <div className="project-card">
            ...
            <div className="project-info">
              ...
              <Link to="/projects#nnpc-pipeline" className="btn-more">
                Learn More
              </Link>
            </div>
          </div>
          <div className="project-card">
            ...
            <div className="project-info">
              ...
              <Link to="/projects#solar-water" className="btn-more">
                Learn More
              </Link>
            </div>
          </div>
